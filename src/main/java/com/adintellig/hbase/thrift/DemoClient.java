...
//        host = args[0];
    ...
    private void run() throws IOError, TException, IllegalArgument,
        ...
        for (int i = 100; i >= 0; --i) {
            ...
            mutations = new ArrayList<Mutation>();
            mutations.add(new Mutation(false, ByteBuffer.wrap(bytes("unused:")), ByteBuffer.wrap(bytes("DELETE_ME")), false));
            ...
            mutations = new ArrayList<Mutation>();
            mutations.add(new Mutation(false, ByteBuffer.wrap(bytes("entry:num")), ByteBuffer.wrap(bytes("0")), false));
            mutations.add(new Mutation(false, ByteBuffer.wrap(bytes("entry:foo")), ByteBuffer.wrap(bytes("FOO")), false));
            client.mutateRow(ByteBuffer.wrap(t), ByteBuffer.wrap(row), mutations, null);
            printRow(client.getRow(ByteBuffer.wrap(t), ByteBuffer.wrap(row), null));
            ...
            mutations = new ArrayList<Mutation>();
            mutations.add(new Mutation(false, ByteBuffer.wrap(bytes("entry:num")), ByteBuffer.wrap(bytes(Integer.toString(i))), false));
            mutations.add(new Mutation(false, ByteBuffer.wrap(bytes("entry:sqr")), ByteBuffer.wrap(bytes(Integer.toString(i * i))), false));
            client.mutateRow(ByteBuffer.wrap(t), ByteBuffer.wrap(row), mutations, null);
            printRow(client.getRow(ByteBuffer.wrap(t), ByteBuffer.wrap(row), null));
            ...
            List<TCell> versions = client.getVer(ByteBuffer.wrap(t), ByteBuffer.wrap(row), ByteBuffer.wrap(bytes("entry:num")), 10, null);
            ...
            List<TCell> result = client.get(ByteBuffer.wrap(t), ByteBuffer.wrap(row), ByteBuffer.wrap(bytes("entry:foo")), null);
